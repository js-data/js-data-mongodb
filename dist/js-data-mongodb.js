...
function MongoDBAdapter(opts) {
  ...
  this.client = new jsData.utils.Promise(function (resolve, reject) {
    mongodb.MongoClient.connect(opts.uri, opts.mongoDriverOpts, function (err, client) {
      if (err) {
        return reject(err);
      }
      _this._db = client.db();
...
jsDataAdapter.Adapter.extend({
  ...
  _count: function _count(mapper, query, opts) {
    ...
    return this._run(function (client, success, failure) {
      ...
      client.collection(collectionId).countDocuments(mongoQuery, countOpts, function (err, count) {
  ...
  _find: function _find(mapper, id, opts) {
    ...
    return this._run(function (client, success, failure) {
      ...
      client.collection(collectionId).findOne(mongoQuery, function (err, record) {
  ...
  _findAll: function _findAll(mapper, query, opts) {
    ...
    return this._run(function (client, success, failure) {
      ...
      client.collection(collectionId).find(mongoQuery).toArray(function (err, records) {
